...
const SignIn = () => {
  ...
  return (
    <div className="border-2  border-lightGray rounded-md bg-gradient-to-tr from-darkGray to-lightGray w-52 mt-8 flex justify-center ">
      <div className="">
        ...
        <form className="">
          ...
          <div>
            <button
              type="submit"
              className="w-44 h-8 mt-3 pt-2 pb-3 bg-white text-center rounded text-darkGray text-xxs font-semibold"
            >
              SIGN IN
            </button>
          </div>
